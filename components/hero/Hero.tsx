...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen bg-[#0C0E14] text-[#F0F4F8] flex flex-col justify-center overflow-hidden py-10 sm:py-16 md:py-20 px-3 sm:px-6 md:px-8 selection:bg-[#F5B942] selection:text-[#0C0E14]">
      ...
      <div className="max-w-6xl mx-auto w-full space-y-10 sm:space-y-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 sm:px-3.5 py-1.5 rounded-full text-[11px] sm:text-xs font-semibold uppercase tracking-wider bg-[#F5B942]/10 text-[#F5B942] border border-[#F5B942]/30">
              <Zap className="w-3.5 h-3.5 fill-[#F5B942]" /> Sovereign Sentinel
            </div>

            <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight font-heading text-white leading-tight">
              RUDRA
            </h1>

            <p className="text-lg sm:text-2xl font-medium text-[#F5B942] font-heading tracking-wide italic">
              &ldquo;Even in the storm, someone is still listening.&rdquo;
            </p>

            <p className="text-sm sm:text-base md:text-lg text-[#94A3B8] max-w-2xl leading-relaxed font-sans mx-auto lg:mx-0">
              To make sure no one has to carry their storm entirely alone.
            </p>

            {/* CTA Button */}
            <div className="pt-2 sm:pt-4 flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-3 sm:gap-4 w-full">
              <a
                href="#chatbot"
                onClick={scrollToChatbot}
                className="btn-primary text-sm sm:text-base px-5 sm:px-6 py-3 sm:py-3.5 shadow-[0_0_25px_rgba(245,185,66,0.35)] w-full sm:w-auto min-h-[44px] shrink-0"
              >
              ...
              <a
                ...
                className="btn-secondary text-sm sm:text-base px-5 sm:px-6 py-3 sm:py-3.5 w-full sm:w-auto min-h-[44px] shrink-0"
              >
          ...
          >
            ...
            <div className="relative w-full max-w-[300px] xs:max-w-[380px] sm:max-w-[480px] lg:max-w-[540px] aspect-square flex items-center justify-center">
        ...
        {/* Short Lore Sections: Scroll-Reveal on Origin, Powers, Mission */}
        <div id="origin" className="pt-8 sm:pt-12 border-t border-[#232838] grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
